...
public class AntiBotAPI {
	...
	/**
	 * Sends a player a puzzle for them to solve.
	 * <b>NOTICE:</b> If you send a puzzle to a exempt player, it will not do anything.
	 * 
	...
	/**
	 * Automatically solves a player's puzzle. This is the way to remove a player's puzzle.
	 * <b>NOTICE:</b> This does nothing if the player doesn't have a puzzle in the first place.
	 * 
