...
public class LoginUnit extends CallUnit
{
    ...
    {
        if(WorkflowAgent.dispatchUnit(e, Handlers.COUNTRYBANS, false))
    ...
    {
    	if(WorkflowAgent.dispatchUnit(e, Handlers.LOGINDELAY, false))
    		e.disallow(PlayerLoginEvent.Result.KICK_FULL, Settings.loginDelayMsg);
    }
